...
#### .NET <a name="net"></a>
* `ClientEncryption.Core` targets .NET Standard 3.1
* `ClientEncryption.RestSharpV2` targets .NET Standard 3.1
* `ClientEncryption.RestSharp` targets .NET Standard 3.1
